sap.ui.define([
	...
	return BaseController.extend("com.evorait.evoplan.controller.map.MapResourceTree", {
		...
		onDropOnResource: function (oEvent) {
			...
			if (this.getModel("user").getProperty("/ENABLE_ASGN_DATE_VALIDATION") && iOperationTimesLen !== aSources.length && this.getModel("viewModel").getProperty("/selectedHierarchyView") === "TIMENONE") {
