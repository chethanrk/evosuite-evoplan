        ...
        _createData: function (data) {
            ...
            if (data.__batchResponses) {
                ...
                for (var a = 0; a < this.selectedResources.length; a++) {
                    ...
                    if((oResource.NodeType=== "RESOURCE" && oUserModel.getProperty("/POOL_FUNCTION") !== "RESOURCE")  || (oResource.NodeType=== "RES_GROUP" && oUserModel.getProperty("/POOL_FUNCTION_ENABLED"))){
