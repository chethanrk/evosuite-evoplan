	...
	return BaseController.extend("com.evorait.evoplan.controller.common.AssignInfoDialog", {
		...
		_getDefaultPRTToolsAssignmentModelObject: function (oAssignmentData) {
			return {
				...
				AllowUnassign: true,
				PrtAssignmentGuid: oAssignmentData.PrtAssignmentGuid,
				DateFrom: formatter.mergeDateTimeWithoutOffSet(oAssignmentData.DATE_FROM, oAssignmentData.TIME_FROM),
				DateTo: formatter.mergeDateTimeWithoutOffSet(oAssignmentData.DATE_TO, oAssignmentData.TIME_TO),
