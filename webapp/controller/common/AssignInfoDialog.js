	...
	return BaseController.extend("com.evorait.evoplan.controller.common.AssignInfoDialog", {
		...
		_getDefaultPRTToolsAssignmentModelObject: function (oAssignmentData) {
			return {
				...
				DateFrom: formatter.mergeDateTime(oAssignmentData.DateFrom, oAssignmentData.TimeFrom),
				DateTo: formatter.mergeDateTime(oAssignmentData.DateTo, oAssignmentData.TimeTo),
