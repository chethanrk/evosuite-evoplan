	...
	return BaseController.extend("com.evorait.evoplan.controller.common.AssignTreeDialog", {
		...
		onSaveDialog: function () {
			...
			if (this._assignPath) {
				...
				if (this._isToolReAssign && (oTargetObj.NodeType === "RES_GROUP" || oTargetObj.IS_PRT || !oTargetObj.ResourceGuid)) { // If tool is reassigned to group or tool or prt then drop the process
