		...
		_createDataModels: function () {
			...
			var oViewModel = new JSONModel({
				...
				Scheduling: {
					...
					btnInsideDateRangeText: this.getModel("i18n").getResourceBundle().getText("xbut.scheduleToogleInside"),
					btnOutsideDateRangeText: this.getModel("i18n").getResourceBundle().getText("xbut.scheduleToogleOutside"),
					iSelectedResponse: 0,
					sScheduleType: "",
					bDateChanged: false,
					bSchedBtnBusy: false,
